          ...
          e.setAttribute("aria-expanded", t ? "true" : "false");
          {
            ...
            e.forEach((e) => {
              t
                ...
                : (e.classList.add("toggled"), e.setAttribute("aria-expanded", "true"));
            });
          }
        }
      }),
                        ...
                        e.querySelectorAll(".main-header-menu .menu-item > a").forEach((e) => {
                          e.addEventListener("focusout", function (e) {
                            ...
                            if (!(t == a || (r && r == a)))
                              ...
                              else if (t.nextElementSibling == a || t.previousElementSibling == a)
                                e && (h(n, !1), t.classList.remove("ast-menu-hover"));
                              else if (o && o == a)
                                h((childSubMenu = t.querySelector(".sub-menu")), !1);
                              else {
                                let e = o,
                                  t = null;
                                for (; null != e; ) {
                    ...
                    for (var o, r = 0; r < t.length; r++)
                      if (
                        ...
                        for (var l = 0; l < o.length; l++)
                          (o[l].removeEventListener("click", AstraToggleSubMenu),
    ...
    if (
      ...
      (d.onclick = function (e) {
        if (
          ...
          !e.target.closest(".ast-search-menu-icon") &&
          !e.target.closest(".ast-search-icon")
        )
          for (
