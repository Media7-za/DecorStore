              ...
              typeof (o = function () {
                ...
                function D() {
                  ...
                  if (((p = Date.now()), (s = !1), (o = null), l > 2 || p - t - 50 < e))
                    for (r = 0, i = c.length; r < i && w.timeRemaining() > u; r++)
                      ((n = c.shift()), v++, n && n(w));
                  c.length ? C() : (l = 0);
                }
                function I(e) {
                  ...
                  try {
                    ...
                    !(function (e) {
                      ...
                      if (
                        ...
                        if (
                          !(n = Object.getOwnPropertyDescriptor(t, "timeRemaining")) ||
                          !n.configurable ||
                          !n.get
                        )
                          return;
