  ...
  ((s, d, p) => {
    ...
    let m = {
      ...
      ready() {
        (m.clearUrlQuery(),
          ...
          p(".wpforms-randomize").each(function () {
            for (
              var e = p(this),
                t = e.children().not(".wpforms-other-choice").toArray(),
                r = e.children(".wpforms-other-choice");
              t.length;
            )
      ...
      loadHoneypot() {
        p(".wpforms-form").each(function () {
          ...
          void 0 !== wpforms_settings.hn_data[t] &&
            (p(`#wpforms-form-${t} .wpforms-field`).each(function () {
              var e = p(this);
              (r.push(e.data("field-id")), a.push(e.find(".wpforms-field-label").text()));
            }),
            (i = m.getHoneypotRandomLabel(a.join(" ").split(" "))),
            (o = m.getHoneypotFieldId(r)),
            (n = r[Math.floor(Math.random() * r.length)]),
            (s = `wpforms-${t}-field_` + o),
            ...
            (n = p(`#wpforms-${t}-field_${wpforms_settings.hn_data[t]}-container`, e))
              .find("input")
      ...
      loadValidation() {
        void 0 === p.fn.validate
          ...
          : (p(".wpforms-input-temp-name").each(function (e, t) {
            ...
            (p.validator.messages.min = e(
              "val_min",
              "Please enter a value greater than or equal to {0}",
            ).replace("{value}", "{0}")),
            (p.validator.messages.max = e(
              "val_max",
            ...
            p.validator.addMethod(
              ...
              function (e, t, r) {
                ...
                if (t.files && t.files.length)
                  for (i = 0, o = t.files.length; i < o; i++) if (t.files[i].size > a) return !1;
                return !0;
              },
            ...
            p.validator.addMethod(
              ...
              function (e, t) {
                ...
                return (
                  !r.length ||
                  !(t.hasAttribute("required") || r.hasClass("wpforms-field-required")) ||
                  (t.files && 0 < t.files.length) ||
                  0 <
                    r.find(".wpforms-camera-selected-file.wpforms-camera-selected-file-active")
                      .length
                );
              },
            ...
            p.validator.addMethod(
              ...
              function (e, t) {
                ...
                return (
                  ...
                  Object.prototype.hasOwnProperty.call(m.cache, r) &&
                  Object.prototype.hasOwnProperty.call(m.cache[r], "restrictedEmailValidation") &&
                  Object.prototype.hasOwnProperty.call(m.cache[r].restrictedEmailValidation, e)
                    ? m.cache[r].restrictedEmailValidation[e]
                    : (m.restrictedEmailRequest(t, e), "pending"))
                );
              },
            ...
            p.validator.addMethod(
              ...
              function (e, t) {
                ...
                return (
                  void 0 === r ||
                  !(t.prop("required") || !m.empty(e)) ||
                  ((t = t.data("max-time")),
                  m.compareTimesGreaterThan(t, r)
                    ? m.compareTimesGreaterThan(e, r) && m.compareTimesGreaterThan(t, e)
                    : (m.compareTimesGreaterThan(e, r) && m.compareTimesGreaterThan(e, t)) ||
                      (m.compareTimesGreaterThan(r, e) && m.compareTimesGreaterThan(t, e)))
                );
              },
              function (e, t) {
                t = p(t);
            ...
            p.validator.addMethod(
              ...
              function (e, t, r) {
                ...
                return (
                  ...
                  Number(m.amountSanitize(m.amountFormat(r))) <= Number(m.amountSanitize(e))
                );
              },
            ...
            p(".wpforms-validate").each(function () {
              let i = p(this),
                ...
                t;
              ((t =
                void 0 !== d["wpforms_" + e] && d["wpforms_" + e].hasOwnProperty("validate")
                  ? d["wpforms_" + e].validate
                    ...
                    : {
                        ...
                        errorPlacement(e, t) {
                          (m.isLikertScaleField(t)
                            ...
                            : m.isWrappedField(t)
                              ...
                              : m.isDateTimeField(t)
                                ? m.dateTimeErrorPlacement(t, e)
                                : m.isFieldInColumn(t) || m.isFieldHasHint(t)
                                  ? t.parent().append(e)
                                  : m.isLeadFormsSelect(t)
                                    ? t.parent().parent().append(e)
                                    : t.hasClass("wp-editor-area")
                                      ? t.parent().parent().parent().append(e)
                                      : m.isClassicFileUploadWithCamera(t)
                                        ? e.insertAfter(
                                            t
                                              .parent()
                                              .find("p.wpforms-file-upload-capture-camera-classic"),
                                          )
                                        : e.insertAfter(t),
                            m.isModernMarkupEnabled() &&
                              e.attr({
                                role: "alert",
                        ...
                        unhighlight(e, t, r) {
                          ...
                          (("radio" === e.attr("type") || "checkbox" === e.attr("type")
                            ...
                            .addClass(r)
                            .removeClass(t),
                            a.find(":input.wpforms-error,[data-dz-errormessage]:not(:empty)")
                        ...
                        submitHandler(s) {
                          function n(e, t) {
                            ...
                            (e.find(".wpforms-recaptcha-container").append(i),
                              ...
                              a
                                ...
                                : m.empty(o) && 0 !== o
                                  ? (p(".wpforms-input-temp-name").removeAttr("name"),
                                    void m.formSubmit(e))
                                  : (grecaptcha.execute(o).then(null, function () {
                          ...
                          return "function" == typeof wpformsRecaptchaV3Execute
                            ? (l(p(s)), wpformsRecaptchaV3Execute(e))
                            : e();
                        },
                        invalidHandler(e, t) {
                          var r, a;
                          void 0 !== t.errorList[0] &&
                            ((t = p(t.errorList[0].element)),
                            (r = p(i)),
                            m.isMultiPageForm(r) &&
                              (a = m.getElementPageNumber(t)) &&
                              WPForms?.PageNavigation?.navigateToTargetPage?.(r, a),
                            m.scrollToError(t));
                        },
                ...
                i.validate(t),
                m.loadValidationGroups(i),
                i
                  .find(
                    '.wpforms-field-camera input[ type="file" ], .wpforms-field-camera .dropzone-input',
                  )
                  .each(function () {
                    var e = p(this);
                    (e.closest(".wpforms-field-camera").hasClass("wpforms-field-required") ||
                      e.attr("required")) &&
                      e.rules("add", { "camera-required": !0 });
                  }));
            }));
      },
      restrictedEmailRequest(r, a) {
        ...
        ((m.cache[o] = m.cache[o] || {}),
          ...
          p.post({
            ...
            type: "post",
            data: { action: "wpforms_restricted_email", form_id: o, field_id: t, email: a },
            dataType: "json",
            success(e) {
              var t = {},
                e = e.success && e.data;
              (e || ((t[r.name] = wpforms_settings.val_email_restricted), i.showErrors(t)),
                (m.cache[o].restrictedEmailValidation = m.cache[o].restrictedEmailValidation || []),
                Object.prototype.hasOwnProperty.call(m.cache[o].restrictedEmailValidation, a) ||
                  (m.cache[o].restrictedEmailValidation[a] = e),
                i.stopRequest(r, e));
            },
          }));
      },
      getValidationIgnoreRules(e) {
        if (m.isMultiPageForm(e) && e.find(".wpforms-page-indicator").data("allow-page-navigation"))
          return ":hidden:not(.wpforms-page:hidden *):not(textarea.wp-editor-area):not(.wpforms-field-camera:not(.wpforms-conditional-hide) input), .wpforms-conditional-hide *, .wpforms-hidden *";
      ...
      dateTimeErrorPlacement(e, t) {
        ...
        r.length
          ? r.find("label.wpforms-error, em.wpforms-error").length || r.append(t)
          : e.closest(".wpforms-field").append(t);
      },
      loadDatePicker(e) {
        void 0 !== p.fn.flatpickr &&
          (e = e?.length ? e : p(s)).find(".wpforms-datepicker-wrap").each(function () {
            let a = p(this),
              e = a.find("input"),
            ...
            var s;
            (!(o =
              void 0 !== d["wpforms_" + r + "_" + i] &&
              d["wpforms_" + r + "_" + i].hasOwnProperty("datepicker")
                ? d["wpforms_" + r + "_" + i].datepicker
                : void 0 !== d["wpforms_" + r] && d["wpforms_" + r].hasOwnProperty("datepicker")
                  ? d["wpforms_" + r].datepicker
                  : "undefined" != typeof wpforms_datepicker
                    ? wpforms_datepicker
                    : { disableMobile: !0 }).hasOwnProperty("locale") &&
              "undefined" != typeof wpforms_settings &&
              wpforms_settings.hasOwnProperty("locale") &&
              (o.locale = wpforms_settings.locale),
              (o.wrap = !0),
              (o.dateFormat = e.data("date-format")),
              1 === e.data("disable-past-dates") &&
                ((o.minDate = "today"), 1 === e.data("disable-todays-date")) &&
                ((s = new Date()), (o.minDate = s.setDate(s.getDate() + 1))));
            ...
            (n &&
              ...
              (o.disable = [
                function (e) {
                  for (var t in n) if (l.indexOf(n[t]) === e.getDay()) return !1;
                  return !0;
                },
              ])),
      ...
      loadTimePicker(e) {
        void 0 !== p.fn.timepicker &&
          (e = e?.length ? e : p(s)).find(".wpforms-timepicker").each(function () {
            var e = p(this),
              t = e.closest(".wpforms-form").data("formid"),
              r = e.closest(".wpforms-field").data("field-id");
            let a;
            a =
              void 0 !== d["wpforms_" + t + "_" + r] &&
              d["wpforms_" + t + "_" + r].hasOwnProperty("timepicker")
                ? d["wpforms_" + t + "_" + r].timepicker
                : void 0 !== d["wpforms_" + t] && d["wpforms_" + t].hasOwnProperty("timepicker")
                  ? d["wpforms_" + t].timepicker
      ...
      loadInputMask(e) {
        void 0 !== p.fn.inputmask &&
          (e = e?.length ? e : p(s)).find(".wpforms-masked-input").inputmask({ rightAlign: !1 });
      },
      fixPhoneFieldSnippets(t) {
        (console.warn(
          "WARNING! Obsolete function called. Function wpforms.fixPhoneFieldSnippets( $field ) has been deprecated, please use the wpforms.repairSmartPhoneHiddenField( $field ) function instead!",
        ),
          t.siblings('input[type="hidden"]').each(function () {
            var e;
            p(this).attr("name").includes("function") &&
              (e = (e = t.data("plugin_intlTelInput")).d || e.options) &&
              (d.intlTelInput?.getInstance(t[0])?.destroy(),
      ...
      repairSmartPhoneHiddenField(e) {
        (console.warn(
          'WARNING! Function "wpforms.repairSmartPhoneHiddenField()" has been deprecated, please use the new "WPFormsPhoneField.repairSmartHiddenField()" function instead!',
        ),
      ...
      getDefaultSmartPhoneFieldOptions() {
        return (
          console.warn(
            'WARNING! Function "wpforms.getDefaultSmartPhoneFieldOptions()" has been deprecated, please use the new "WPFormsPhoneField.getDefaultSmartFieldOptions()" function instead!',
          ),
      ...
      loadSmartPhoneField(e) {
        (console.warn(
          'WARNING! Function "wpforms.loadSmartPhoneField()" has been deprecated, please use the new "WPFormsPhoneField.loadSmartField()" function instead!',
        ),
          WPFormsPhoneField?.loadSmartField?.(e));
      },
      loadJqueryIntlTelInput() {
        (console.warn(
          'WARNING! Function "wpforms.loadJqueryIntlTelInput()" has been deprecated, please use the new "WPFormsPhoneField.loadJqueryIntlTelInput()" function instead!',
        ),
          WPFormsPhoneField?.loadJqueryIntlTelInput?.());
      },
      initSmartPhoneField(e, t) {
        (console.warn(
          'WARNING! Function "wpforms.initSmartPhoneField()" has been deprecated, please use the new "WPFormsPhoneField.initSmartField()" function instead!',
        ),
          WPFormsPhoneField?.initSmartField?.(e, t));
      },
      bindSmartPhoneField() {
        (console.warn(
          'WARNING! Function "wpforms.bindSmartPhoneField()" has been deprecated, please use the new "WPFormsPhoneField.bindSmartField()" function instead!',
        ),
      ...
      loadPayments() {
        (p("input.wpforms-payment-total").each(function (e, t) {
          ...
          void 0 !== p.fn.payment &&
            (p(".wpforms-field-credit-card-cardnumber").payment("formatCardNumber"),
        ...
        "function" == typeof d.Choices &&
          (o = o?.length ? o : p(s))
            ...
            .each(function (e, t) {
              var r, a, i;
              p(t).data("choicesjs") ||
                WPFormsUtils.triggerEvent(o, "wpformsBeforeLoadElementChoices", [
                  t,
                ]).isDefaultPrevented() ||
                ((r = d.wpforms_choicesjs_config || {}),
                (a = p(t).data("search-enabled")),
                (i = p(t).data("remove-items-enabled")),
                (r.searchEnabled = void 0 === a || a),
                (r.removeItems = void 0 === i || i),
                ...
                (r.callbackOnInit = function () {
                  ...
                  var l;
                  (t.containerOuter &&
                    t.containerOuter.element &&
                    o &&
                    n &&
                    (t.containerOuter.element.setAttribute("aria-haspopup", "listbox"),
                    t.containerOuter.element.setAttribute("aria-labelledby", o)),
                    e &&
                      s &&
                      ((l = "choices-listbox-" + this.passedElement.element.id),
                      (s.id = l),
                    ...
                    i && p(t.containerOuter.element).addClass(i),
                    r.prop("multiple") &&
                      (a.data("placeholder", a.attr("placeholder")).css("width", "auto"),
                    ...
                    r.on("change", function () {
                      r.prop("multiple") &&
                        (t.getValue(!0).length
                          ...
                          : a.attr("placeholder", a.data("placeholder")).css("width", "auto"));
        ...
        (e.on("wpformsProcessConditionals", function (e, t) {
          ...
          e.on(
            ...
            function (e) {
              ...
              switch (t.attr("type")) {
                ...
                case "checkbox":
                  t.is(":checked")
                    ? (t.closest("li").addClass("wpforms-selected"), t.prop("checked", !0))
                    : (t.closest("li").removeClass("wpforms-selected"), t.prop("checked", !1));
              }
            },
          ),
          e.on("input", ".wpforms-field-file-upload", function () {
            var e = p(this),
              t = e
                ...
                .find('.wpforms-field-file-upload input:not(".dropzone-input")');
            let a = 0,
            ...
            (0 !== n.find(".wpforms-page-indicator").length && 0 !== l.length && (o = l),
              t.each(function () {
                var e = p(this);
                let t = 0;
              ...
              a < r
                ? (s.find(".wpforms-error-container-post_max_size").remove(),
                  o.prop("disabled", !1),
                  WPFormsUtils.triggerEvent(n, "wpformsFormSubmitButtonRestore", [n, o]),
                  WPFormsUtils.triggerEvent(n, "wpformsCombinedUploadsSizeOk", [n, s]))
                : ((a = Number((a / 1048576).toFixed(3))),
                  (r = Number((r / 1048576).toFixed(3))),
                  (i = i.replace(/{totalSize}/, a).replace(/{maxSize}/, r)),
                  s.hasClass("wpforms-error-container")
                    ? (s.find(".wpforms-error-container-post_max_size").remove(), s.append(i))
                    : (e.before(
                      ...
                      (s = e.prev())),
                  o.prop("disabled", !0),
                  WPFormsUtils.triggerEvent(n, "wpformsFormSubmitButtonDisable", [n, o]),
          ...
          e.on("keydown", ".wpforms-form input", function (e) {
            ...
            13 !== e.keyCode ||
              ...
              ["text", "tel", "number", "email", "url", "radio", "checkbox"].indexOf(
                t.attr("type"),
              ) < 0 ||
              (t.hasClass("wpforms-datepicker") && t.flatpickr("close"),
              t.hasClass("dropzone-input")) ||
              (e.preventDefault(),
              (r.hasClass("last")
          ...
          e
            ...
            .one("change", ".wpforms-field-select-style-modern, .wpforms-timepicker", m.formChanged)
            .one("focus", ".dropzone-input", m.formChanged)
            .one("click touchstart", ".wpforms-signature-canvas", m.formChanged)
            .one("wpformsRichTextContentChange", m.richTextContentChanged),
      ...
      bindOtherOptionActions() {
        p(s).on("change", '.wpforms-field-radio input[type="radio"]', function () {
          ...
          (t.addClass("wpforms-hidden").prop("disabled", !0).prop("required", !1),
            e.is(":checked") &&
              r.hasClass("wpforms-other-choice") &&
              t.removeClass("wpforms-hidden").prop("disabled", !1).prop("required", !0));
        });
      },
      ...
      isEmptyPage(e, t) {
        return (
          ...
          ((t = m.removeHoneyPotField(
            e.children(".wpforms-field:not(.wpforms-field-pagebreak):not(.wpforms-field-hidden)"),
          )),
          e.children(".wpforms-conditional-hide").length === t.length)
        );
      },
      ...
      getStartTimestampData(e) {
        return e.hasClass("wpforms-form") && 0 < (e = parseInt(e.data("start_timestamp"), 10) || 0)
          ? e
          : 0;
      },
      ...
      scrollToError(e) {
        if (0 !== e.length) {
          ...
          0 !== (t = 0 === t.length ? e.closest(".wpforms-field") : t).length &&
            void 0 !== (e = t.offset()) &&
            m.animateScrollTop(e.top - 75, 750).done(function () {
      ...
      pagebreakNav(e) {
        ...
        (m.saveTinyMCE(),
          "next" === r && void 0 !== p.fn.validate
            ? m.checkForInvalidFields(i, o, function () {
        ...
        if (!t.hasClass("wpforms-disabled")) {
          ...
          ("next" === r ? (e += 1) : "prev" === r && --e,
            WPFormsUtils.triggerEvent(t, "wpformsBeforePageChange", [
              ...
              (i.find(".wpforms-page").hide(),
              (a = i.find(".wpforms-page-" + e)).show(),
              m.toggleReCaptchaAndSubmitDisplay(i, r, a),
              m.checkTurnstileVisibility(i),
              (a = m.getPageScroll(i)) && m.animateScrollTop(i.offset().top - a, 750, null),
              t.trigger("wpformsPageChange", [e, i, r]),
              m.manipulateIndicator(e, i)));
        }
      },
      ...
      checkTurnstileVisibility(e) {
        ...
        e.hasClass("wpforms-is-turnstile") &&
          ((t = e.find(".wpforms-turnstile").height()),
          0 === parseInt(t, 10)
      ...
      getPageScroll(e) {
        return (
          !1 !== d.wpforms_pageScroll &&
          (m.empty(d.wpform_pageScroll)
      ...
      manipulateIndicator(e, t) {
        ...
        a &&
          ("connector" === (r = a.data("indicator")) || "circles" === r
            ? m.manipulateConnectorAndCirclesIndicator(a, r, e)
            : "progress" === r && m.manipulateProgressIndicator(a, t, e));
      },
      manipulateConnectorAndCirclesIndicator(e, t, r) {
        ...
        (e.find(".wpforms-page-indicator-page").removeClass("active"),
          ...
          "connector" === t &&
            (e.find(".wpforms-page-indicator-page-triangle").removeAttr("style"),
      ...
      optinMonsterRecaptchaReset(e) {
        ...
        let a, i, o;
        if (
          ((o = r.hasClass("wpforms-is-hcaptcha")
            ? ((a = e.find(".h-captcha")), (i = "h-captcha"), hcaptcha)
            : r.hasClass("wpforms-is-turnstile")
              ? ((a = e.find(".wpforms-turnstile")), (i = "wpforms-turnstile"), turnstile)
              : ((a = e.find(".g-recaptcha")), (i = "g-recaptcha"), grecaptcha)),
          e.length && a.length)
        ) {
          let e = a.attr("data-sitekey"),
            t = "recaptcha-" + Date.now();
          (a.remove(),
            r.prepend('<div class="' + i + '" id="' + t + '" data-sitekey="' + e + '"></div>'),
            o.render(t, {
              sitekey: e,
              callback() {
        ...
        if (m.allowAmountTotalCalc(a, r, i)) {
          ...
          (a.find(".wpforms-payment-total").each(function () {
            "hidden" === p(this).attr("type") || "text" === p(this).attr("type")
              ? (p(this).val(e),
                "text" === p(this).attr("type") && t && a.data("validator") && p(this).valid())
              : p(this).text(e);
          }),
      ...
      allowAmountTotalCalc(e, t, r) {
        var e = e.data("formid");
        return m.getCache(e, "amountTotal") !== r
          ? (m.updateCache(e, "amountTotal", r), !0)
          : "radio" === (e = t.prop("type")) || "select-one" === e || "checkbox" === e;
      },
          ...
          a.each(function () {
            let a = p(this),
              e =
                ("" !== r &&
                  a
                    .find(".wpforms-order-summary-preview-total .wpforms-order-summary-item-price")
                    .text(r),
                (t) => {
      ...
      getCache(e, t) {
        return (
          !(
            !Object.prototype.hasOwnProperty.call(m.cache, e) ||
            !Object.prototype.hasOwnProperty.call(m.cache[e], t)
          ) && m.cache[e][t]
        );
      },
      updateOrderSummaryItem(i, o) {
        if (i.hasClass("wpforms-payment-price")) {
          ...
          var s, n;
          ("checkbox" === r || "radio" === r || "select-one" === r
            ? o.find(`tr[data-field="${e}"]`).each(function () {
                var e = p(this).data("choice"),
                  e =
                    "select-one" === r
                      ? e === parseInt(t.find("select").val(), 10)
                      : t.find(`input[value="${e}"]`).is(":checked");
                p(this).toggle(a && e);
              })
            : ((s = o.find(`tr[data-field="${e}"]`)),
              (n = i.val()),
              s
                .find(".wpforms-order-summary-item-price")
                .text(m.amountFormatSymbol(m.amountSanitize(n))),
              s.toggle(a)),
            t.hasClass("wpforms-payment-quantities-enabled")
              ? m.updateOrderSummaryItemQuantity(i)
              : (m.updateSummaryPriceWidth(o), m.toggleSummaryPlaceholder(o)));
        }
      },
        ...
        r.find(".wpforms-order-summary-preview").each(function () {
          ...
          ((r =
            "checkbox" === n || "radio" === n || "select-one" === n
              ? ((e = a.val()), t.find(`tr[data-field="${i}"][data-choice="${e}"]`))
              : t.find(`tr[data-field="${i}"]`)).toggle(0 < o),
            r.find(".wpforms-order-summary-item-quantity").text(o),
            r.find(".wpforms-order-summary-item-price").text(m.amountFormatSymbol(s * o)),
      ...
      updateSummaryPriceWidth(e) {
        var t = Math.max(
          e
            .find(".wpforms-order-summary-preview-coupon-total .wpforms-order-summary-item-price")
            .text().length,
          e.find(".wpforms-order-summary-preview-total .wpforms-order-summary-item-price").text()
            .length + 3,
        );
      ...
      amountTotalCalc(e) {
        ...
        p(".wpforms-payment-price", e).each(function () {
          ...
          t.closest(".wpforms-field-payment-single").hasClass("wpforms-conditional-hide") ||
            ((e = m.getPaymentFieldAmount(t)) &&
              (r = Number(r) + e * m.getPaymentFieldQuantity(t)));
        });
        var t = p(s),
      ...
      getPaymentFieldAmount(e) {
        ...
        return "text" === t || "hidden" === t
          ? Number(m.amountSanitize(e.val()))
          : ("radio" !== t && "checkbox" !== t) || !e.is(":checked")
            ? e.is("select") &&
              0 < e.find("option:selected").length &&
              e.find("option:selected").data("amount")
              ? Number(m.amountSanitize(e.find("option:selected").data("amount")))
              : 0
            : Number(m.amountSanitize(e.data("amount")));
      },
      ...
      numberFormat(e, t, r, a) {
        ...
        var i,
          ...
          s = (
            t
              ? ((s = e), (i = t), (o = Math.pow(10, i)), "" + (Math.round(s * o) / o).toFixed(i))
              : "" + Math.round(e)
          ).split(".");
        return (
          3 < s[0].length && (s[0] = s[0].replace(/\B(?=(?:\d{3})+(?!\d))/g, a)),
          (s[1] || "").length < t &&
            ((s[1] = s[1] || ""), (s[1] += new Array(t - s[1].length + 1).join("0"))),
          s.join(r)
        );
      },
      empty(e) {
        ...
        for (a = 0, t = i.length; a < t; a++) if (e === i[a]) return !0;
      ...
      setUserIdentifier() {
        if (
          ((!d.hasRequiredConsent &&
            "undefined" != typeof wpforms_settings &&
            wpforms_settings.uuid_cookie) ||
            (d.hasRequiredConsent && d.hasRequiredConsent())) &&
          !m.getCookie("_wpfuuid")
        ) {
          var t = new Array(36),
            r = "0123456789abcdef";
      ...
      createCookie(e, t, r) {
        ...
        (wpforms_settings.is_ssl && (i = ";secure"),
          (a = r
            ? -1 === r
              ? ""
              : ((o = new Date()).setTime(o.getTime() + 24 * r * 60 * 60 * 1e3),
                ";expires=" + o.toGMTString())
            : ";expires=Thu, 01 Jan 1970 00:00:01 GMT"),
          (s.cookie = e + "=" + t + a + ";path=/;samesite=strict" + i));
      },
      getCookie(e) {
        var r = e + "=",
          a = s.cookie.split(";");
      ...
      getFirstBrowserLanguage() {
        return (
          console.warn(
            'WARNING! Function "wpforms.getFirstBrowserLanguage()" has been deprecated, please use the new "WPFormsPhoneField.getFirstBrowserLanguage()" function instead!',
          ),
      ...
      mapLanguageToIso(e) {
        return (
          console.warn(
            'WARNING! Function "wpforms.mapLanguageToIso()" has been deprecated, please use the new "WPFormsPhoneField.mapLanguageToIso()" function instead!',
          ),
      ...
      currentIpToCountry(e) {
        (console.warn(
          'WARNING! Function "wpforms.currentIpToCountry()" has been deprecated, please use the new "WPFormsPhoneField.currentIpToCountry()" function instead!',
        ),
        ...
        e.length &&
          ...
          e.append(
            '<input type="hidden" name="start_timestamp" value="' +
              m.getStartTimestampData(e) +
              '">',
          ),
          e.append(
            '<input type="hidden" name="end_timestamp" value="' + m.getTimestampSec() + '">',
          ),
          e.get(0).submit());
      },
      formHasCaptcha(e) {
      ...
      resetFormRecaptcha(r) {
        if (m.formHasCaptcha(r)) {
          ...
          ((e = a.hasClass("wpforms-is-hcaptcha")
            ...
            m.empty(t) &&
              0 !== t &&
              (a = r.find(".g-recaptcha, .h-captcha, .wpforms-turnstile")).length &&
              (t = a.data("recaptcha-id")),
      ...
      displayFormAjaxErrors(e, t) {
        "string" == typeof t
          ? m.displayFormAjaxGeneralErrors(e, t)
          : ((t = t && "errors" in t ? t.errors : null),
            m.empty(t) || (m.empty(t.general) && m.empty(t.field))
              ? m.consoleLogAjaxError()
              : (m.empty(t.general) || m.displayFormAjaxGeneralErrors(e, t.general),
      ...
      displayFormAjaxGeneralErrors(e, t) {
        ...
        e &&
          ...
          (m.empty(t) ||
            ...
            "string" == typeof t
              ? ((a = m.isModernMarkupEnabled() ? ' role="alert"' : ""),
                (r = m.isModernMarkupEnabled()
                  ? `<span class="wpforms-hidden">${wpforms_settings.formErrorMessagePrefix}</span>`
                  : ""),
                e
                  .find(".wpforms-submit-container")
                  .before(`<div class="wpforms-error-container"${a}>${r}${t}</div>`),
                m.setCurrentPage(e, {}))
              : ((a = e.data("formid")), m.printGeneralErrors(e, t, a))));
      },
      printGeneralErrors(o, e, s) {
        (p.each(e, function (e, t) {
            ...
            case "footer_styled":
              ((a = t),
                0 === o.find(".wpforms-page-indicator").length
                  ? o.find(".wpforms-submit-container").before(a)
                  : o.find(".wpforms-page-1").append(a));
              break;
            case "recaptcha":
          ...
          var r, a, i;
          m.isModernMarkupEnabled() &&
            ((i = o.attr("aria-errormessage") || ""),
            o.attr("aria-errormessage", i + ` wpforms-${s}-${e}-error`));
        }),
          o.find(".wpforms-error-container").length &&
            m.animateScrollTop(o.find(".wpforms-error-container").first().offset().top - 100));
      },
        ...
        p.each(o, function (i, e) {
          "string" != typeof e &&
            p.each(e, function (e, t) {
              ...
              r === e
                ? (o[i] = t)
                : "string" == typeof e && e.match(/^r\d+$/)
                  ? ((r = e.replace(/^r/, "")), (o[a + "[" + r + "]"] = t))
                  : "string" == typeof e && isNaN(e) && (o[a + "[" + e + "]"] = t);
            });
        }),
        o
      ),
      formSubmitAjax: (a) => {
        ...
        var t = new FormData(a.get(0)),
          t =
            (t.append("action", "wpforms_submit"),
        ...
        return (
          (t.success = function (e) {
            ...
            if (e)
              if (e.data && e.data.action_required) a.trigger("wpformsAjaxSubmitActionRequired", e);
                ...
                if ((a.trigger("wpformsAjaxSubmitSuccess", e), e.data))
                  return e.data.redirect_url
                    ? ((t = e.data.new_tab || !1),
                      a.trigger("wpformsAjaxSubmitBeforeRedirect", e),
                      t
                        ? (d.open(e.data.redirect_url, "_blank"), void location.reload())
                        : void (d.location = e.data.redirect_url))
                    : void (
                        e.data.confirmation &&
                        (r.html(e.data.confirmation),
                        (i = r.find("div.wpforms-confirmation-scroll")),
                        r.trigger("wpformsAjaxSubmitSuccessConfirmation", e),
                        i.length) &&
                        m.animateScrollTop(i.offset().top - 100)
                      );
              } else
          ...
          (t.complete = function (e, t) {
            (e.responseJSON &&
              ...
              (m.restoreSubmitButton(a, r), a.trigger("wpformsAjaxSubmitCompleted", [e, t]));
          }),
          WPFormsUtils.triggerEvent(a, "wpformsAjaxBeforeSubmit", [a]).isDefaultPrevented()
            ? (m.restoreSubmitButton(a, r), p.Deferred().reject())
            : p.ajax(t)
        );
      },
      setCurrentPage(a, i) {
        if (0 !== a.find(".wpforms-page-indicator").length) {
          ...
          if (
            ...
            0 !== r.length ||
              void 0 === i.errors ||
              void 0 === i.errors.general ||
              void 0 !== i.errors.general.footer ||
              void 0 === i.errors.general.recaptcha)
          ) {
            var o = 0 < r.length ? r[0] : a.find(".wpforms-page-1");
            let e,
              t = "prev";
            1 === o.data("page") || (void 0 !== i.errors && void 0 !== i.errors.general.footer)
        ...
        if (0 !== t.find(".wpforms-page-indicator").length) {
          ...
          if (!r.is(":visible") || !i)
            if (t.find(".wpforms-page-indicator").data("allow-page-navigation")) {
              ...
              (!i &&
                a &&
                ((a = t.find(a).first().closest(".wpforms-page")), (e = a.data("page") || 1)),
                WPForms.PageNavigation.navigateToTargetPage(t, e),
                i && m.checkForInvalidFields(t, r, function () {}));
      ...
      updateToken(t, r, a) {
        ...
        ((this.isUpdatingToken = !0),
          i.prop("disabled", !0),
          p
            .post(wpforms_settings.ajaxurl, { action: "wpforms_get_token", formId: e })
            .done(function (e) {
              e.success
                ? (r.attr("data-token-time", t),
                  r.attr("data-token", e.data.token),
                  i.prop("disabled", !1),
                  a.target === i[0] && i.trigger("click"))
      ...
      getDateTimeValidationGroups(e) {
        let a = {};
        return (
          e.find(".wpforms-field.wpforms-field-date-time").each(function () {
            var e = p(this);
      ...
      lockField(e) {
        ...
        (wpforms_settings.readOnlyDisallowedFields ?? []).includes(t) ||
          (e
            .addClass(a)
            .find("input, textarea, select:not(.wpforms-field-select-style-modern)")
            .prop("readonly", !0)
            .attr("tabindex", "-1"),
          e.hasClass("wpforms-field-select-style-modern")
            ? ((t = e.find("select")).data("choicesjs")?.disable(), t.removeAttr("disabled"))
            : e.hasClass("wpforms-field-richtext") && d.WPFormsRichTextField?.lockField(e));
      },
      unlockField(e) {
        (e
          .removeClass(a)
          ...
          .attr("tabindex", null),
          e.hasClass("wpforms-field-select-style-modern")
            ? e.find("select").data("choicesjs")?.enable()
            : e.hasClass("wpforms-field-richtext") && d.WPFormsRichTextField?.unlockField(e));
      },
      readOnlyFieldsInit() {
