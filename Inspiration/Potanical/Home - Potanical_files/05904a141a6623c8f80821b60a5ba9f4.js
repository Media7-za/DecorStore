...
(() => {
  ...
  var e = {
      d: (r, o) => {
        for (var s in o)
          e.o(o, s) && !e.o(r, s) && Object.defineProperty(r, s, { enumerable: !0, get: o[s] });
      },
    ...
    r = {};
  (e.r(r), e.d(r, { __dangerousOptInToUnstableAPIsOnlyForCoreModules: () => t }));
  const o = [
    ...
    t = (e, r) => {
      ...
      return (s.push(r), { lock: n, unlock: i });
    };
  function n(e, r) {
