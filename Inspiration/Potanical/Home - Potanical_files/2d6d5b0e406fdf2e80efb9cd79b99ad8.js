...
(() => {
  ...
  const T = {
    ...
    L = g(
      ...
      (e) =>
        (t, r = o) =>
          [...e(r), t.toLowerCase()].join("+"),
    ),
    _ = g(T, (e) => (t, r = o) => {
      const n = r(),
        i = { [S]: n ? "⌥" : "Alt", [E]: n ? "⌃" : "Ctrl", [A]: "⌘", [O]: n ? "⇧" : "Shift" };
      return [
        ...e(r).reduce((e, t) => {
          const r = i[t] ?? t;
          return n ? [...e, r] : [...e, r, "+"];
    ...
    k = g(T, (e) => (t, n = o) => {
      ...
      return [...e(n), t].map((e) => b(l[e] ?? e)).join(i ? " " : " + ");
    });
  const v = g(T, (e) => (t, r, n = o) => {
    const i = e(n),
      l = (function (e) {
    ...
    return r
      ? (t.altKey && 1 === r.length && (d = String.fromCharCode(t.keyCode).toLowerCase()),
        t.shiftKey && 1 === r.length && a[t.code] && (d = a[t.code]),
        "del" === r && (r = "delete"),
        d === r.toLowerCase())
      : i.includes(d);
  });
