...
*/
  ...
  function K(a, b) {
    ...
    b === "port"
      ...
      : b === "host" &&
        (a.hostname = (a.hostname || C.location.hostname).replace(J, "").toLowerCase());
    return M(a, b);
  }
  function M(a, b, c) {
    var d = L(a.protocol);
  ...
  function T(a, b, c, d, e) {
    a = { callback: a, domains: b, fragment: c === 2, placement: c, forms: d, sameHost: e };
    S().decorators.push(a);
  }
  function U(a, b, c) {
  ...
  function la(a, b) {
    a = [
      ...
      Math.floor(new Date(Date.now()).getTime() / 60 / 1e3) - (b === void 0 ? 0 : b),
      a,
    ].join("*");
    if (!(b = Q)) {
      b = Array(256);
  ...
  function ma(a) {
    return function (b) {
      ...
      e < 0
        ? (e = void 0)
        : ((f = k.indexOf("&", e)), (e = f < 0 ? k.substring(e) : k.substring(e, f)));
      b.fragment = na(e || "") || {};
      a && oa(c, d, k);
    };
  }
...
(function () {
  ...
  function pf(a) {
    ...
    !c &&
      vd.get(90) &&
      ((c = !0), (d = a.get(lb)), (e = of(!!a.get(ec), !!a.get(Kd))), d !== e && (b = !0));
        ...
        g
          ? b
            ? ((ca = ca || ua),
              b == "image"
                ? wc(e, l, ca)
                : (b == "xhr" && wd(e, l, ca)) || (b == "beacon" && x(e, l, ca)) || ba(e, l, ca))
            : ba(e, l, ca)
          : ca && ca();
    }
    l = h(k);
  ...
  function mf(a, b) {
    if (a)
      if (typeof a === "object") for (var c in a) a.hasOwnProperty(c) && hf(c, b);
      else hf(a, b);
  }
  var ue = new ee(),
    ve = [],
        ...
        if (a.get(je)) {
          if ((b = P(a, ce))) {
            ...
            g && g != "aw.ds"
              ? d && (d.ua = !0)
              : ((b = ["1", e, Cc(b)].join(".")),
                c >= 0 && (d && (d.ta = !0), zc("_gac_" + Cc(k), b, ca, l, k, c, w)));
            le(d);
          }
        } else J(75);
        a.get(je) &&
          ...
          (a = P(a, Be)),
          (b = ["1", w, Cc(b)].join(".")),
          c >= 0 && (d && (d.ta = !0), zc("_gac_gb_" + Cc(k), b, ca, l, k, c, a)),
          ef(d));
      }
    },
    ma = function (a, b, c, d) {
  ...
  var qd = function (a, b, c) {
      ...
      b = c
        ...
        : e == -1
          ? b + ((d === -1 ? "?" : "&") + a)
          : b.substring(0, e) + (d === -1 || d > e ? "?" : "&") + a + b.substring(e);
      b = b.replace(/&+_ga=/, "&_ga=");
  ...
  var p = /^(GTM|OPT)-[A-Z0-9]+$/,
    ...
    He = function (a, b) {
      ...
      O[a.B] = O[a.B] || [];
      wf[a.B] ||
        ((wf[a.B] = !0), (c = { "gtm.start": c }), a.sync || (c.event = "gtm.js"), O[a.B].push(c));
      a.type === 2 &&
        (function (d, e, g) {
  ...
  var u = function (a, b, c) {
    ...
    B = function (a) {
      ...
      return a.host == "www.google-analytics.com" && (a.port || b) == b && D(a.path, "/plugins/")
        ? !0
        : !1;
    },
    ne = function (a) {
  ...
  function rf(a) {
    return (
      a.get(Ie) === void 0 && a.get(fa) === void 0 && a.get(gd) === void 0 && a.get(oe) === void 0
    );
  }
  var N = function (a) {
    J(1);
