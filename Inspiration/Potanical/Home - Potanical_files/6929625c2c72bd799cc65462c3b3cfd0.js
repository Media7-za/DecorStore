jQuery(function (t) {
    ...
    var e = function () {
      t("select.country_select:visible, select.state_select:visible").each(function () {
        var e = t(this),
          n = t.extend(
            {
              placeholder: e.attr("data-placeholder") || e.attr("placeholder") || "",
              label: e.attr("data-label") || null,
              required: "true" === e.attr("aria-required") || null,
              width: "100%",
            },
            {
              language: {
                ...
                inputTooLong: function (t) {
                  ...
                  return 1 === e
                    ...
                    : wc_country_select_params.i18n_input_too_long_n.replace("%qty%", e);
                },
                inputTooShort: function (t) {
                  var e = t.minimum - t.input.length;
                  return 1 === e
                    ? wc_country_select_params.i18n_input_too_short_1
                    : wc_country_select_params.i18n_input_too_short_n.replace("%qty%", e);
                },
  ...
  (t(document.body).on(
    ...
    function () {
      ...
      if ((u === wc_country_select_params.i18n_select_state_text && (u = ""), a[c]))
        if (t.isEmptyObject(a[c]))
          ((n = t('<input type="hidden" />')
            ...
            r.replaceWith(n),
            t(document.body).trigger("country_to_state_changed", [c, e]));
        else {
          var d = a[c],
            m = t('<option value=""></option>').text(
          ...
          (u || (u = wc_country_select_params.i18n_select_state_text),
            ...
            r.empty().append(m),
            t.each(d, function (e) {
              var n = t("<option></option>").prop("value", e).text(d[e]);
              r.append(n);
            }),
    ...
    t(document.body).on("wc_address_i18n_ready", function () {
      t(o).each(function () {
        var e = t(this).find("#billing_country, #shipping_country, #calc_shipping_country");
