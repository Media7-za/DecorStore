...
(() => {
  ...
  function h(t) {
    return d(i(t.ownerDocument.body)).find(
  ...
  function g(t) {
    if (!t.collapsed) {
      ...
      for (const { top: t, bottom: e, left: s, right: c } of n)
        (t < r && (r = t), e > o && (o = e), s < i && (i = s), c > a && (a = c));
  ...
  function A(t) {
    ...
    t.lastChild;
    p();
    const l = a.nodeType === a.TEXT_NODE ? a.data.length : a.childNodes.length;
    return R(i, t, "firstChild") && R(a, t, "lastChild") && 0 === s && c === l;
  }
  function R(t, e, n) {
    let r = e;
    do {
  ...
  function M(t, e, n) {
    let r = n();
    return (r && r.startContainer && t.contains(r.startContainer)) ||
      (t.scrollIntoView(e), (r = n()), r && r.startContainer && t.contains(r.startContainer))
      ? r
      : null;
  }
  function I(t, e, n = !1) {
    if (O(t) && "number" == typeof t.selectionStart)
      return (
    ...
    if (!l && f && f > u.height && c === e) return !1;
    const m = P(t) ? !e : e,
  ...
  (t.r(r),
    t.d(r, { find: () => f, findNext: () => h, findPrevious: () => m, isTabbableIndex: () => s }));
  const _ = window.wp.deprecated;
  var F = t.n(_);
  function V(t) {
    return (
      F()("wp.dom.isNumberInput", { since: "6.1", version: "6.5" }),
  ...
  const tt = {
    ...
    math: { attributes: ["display", "xmlns"], children: "*" },
  };
  function et(t) {
    ...
    const {
      ...
      bdo: s,
      ...c
    } = { ...tt, ins: { children: tt.ins.children }, del: { children: tt.del.children } };
    return c;
  }
  function nt(t) {
  ...
  function it(t, e, n, r) {
    Array.from(t).forEach((t) => {
      ...
      if (!n.hasOwnProperty(o) || (n[o].isMatch && !n[o].isMatch?.(t)))
        (it(t.childNodes, e, n, r),
          r && !nt(t) && t.nextElementSibling && q(e.createElement("br"), t),
          X(t));
      else if (
        (function (t) {
        ...
        if (t.hasChildNodes()) {
          ...
          if (s)
            c.length && !t.querySelector(c.join(","))
              ? (it(t.childNodes, e, n, r), X(t))
              : t.parentNode && "BODY" === t.parentNode.nodeName && nt(t)
                ? (it(t.childNodes, e, n, r), Array.from(t.childNodes).some((t) => !nt(t)) && X(t))
                : it(t.childNodes, e, s, r);
          else for (; t.firstChild; ) W(t.firstChild);
        }
      }
    });
  }
  ...
  function st(t) {
    ...
    return (
      Array.from(t.items).forEach((t) => {
        ...
        n &&
          !e.find(
            ({ name: t, type: e, size: r }) => t === n.name && e === n.type && r === n.size,
          ) &&
          e.push(n);
      }),
      e
  ...
  const ct = { focusable: n, tabbable: r };
