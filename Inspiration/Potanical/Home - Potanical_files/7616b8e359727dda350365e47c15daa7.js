...
var punycode = new (function () {
    ...
    decode: function (r) {
      for (var e, o, t = [], n = 0, f = r.length; n < f; ) {
        if (55296 == (63488 & (e = r.charCodeAt(n++)))) {
          if (((o = r.charCodeAt(n++)), 55296 != (64512 & e) || 56320 != (64512 & o)))
  ...
  ((this.decode = function (r, e) {
    ...
    for (p < 0 && (p = 0), t = 0; t < p; ++t) {
      if ((e && (u[l.length] = r.charCodeAt(t) - 65 < 26), 128 <= r.charCodeAt(t)))
    ...
    for (n = 0 < p ? p + 1 : 0; n < d; ) {
      ...
      if (
        ((C = (function (r, e, o) {
          var t;
          for (r = o ? Math.floor(r / 700) : r >> 1, r += Math.floor(r / e), t = 0; 455 < r; t += v)
            r = Math.floor(r / 35);
