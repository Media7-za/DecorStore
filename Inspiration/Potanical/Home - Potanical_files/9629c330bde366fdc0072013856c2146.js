    ...
    (a.prototype.onAddToCart = function (a) {
      ...
      if (e.is(".ajax_add_to_cart")) {
        ...
        if (
          ...
          return (
            t(document.body).trigger("ajax_request_not_sent.adding_to_cart", [!1, !1, e]),
            !0
          );
        var r = {};
    ...
    (a.prototype.updateButton = function (a, e, r, o) {
      if ((o = void 0 !== o && o)) {
        if (
          ...
          e && o.addClass("added"),
          e && !wc_add_to_cart_params.is_cart && 0 === o.parent().find(".added_to_cart").length)
        ) {
          var d = document.createElement("a");
          ((d.href = wc_add_to_cart_params.cart_url),
            (d.className = "added_to_cart wc-forward"),
            (d.title = wc_add_to_cart_params.i18n_view_cart),
            (d.textContent = wc_add_to_cart_params.i18n_view_cart),
            o.after(d));
        }
