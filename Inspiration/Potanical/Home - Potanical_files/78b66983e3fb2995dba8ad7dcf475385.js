...
!(function (e, t) {
  ...
  var re = (function t() {
        ...
        if (!dt || dt !== e) {
          if (
            ...
            $e &&
              ...
              !0 === $e.svg && (R(Ne, k), R(Re, P), R(Re, H)),
              !0 === $e.svgFilters && (R(Ne, x), R(Re, P), R(Re, H)),
              !0 === $e.mathMl && (R(Ne, I), R(Re, F), R(Re, H))),
            _(e, "ADD_TAGS") || (ke.tagCheck = null),
            _(e, "ADD_ATTR") || (ke.attributeCheck = null),
            e.ADD_TAGS &&
    ...
    const wt = function (e) {
        ...
        if (!(ke.tagCheck instanceof Function && ke.tagCheck(n)) && (!Ne[n] || Oe[n])) {
          if (!Oe[n] && Ot(n)) {
      ...
      Ct = function (e, t, n) {
        ...
        else if (ke.attributeCheck instanceof Function && ke.attributeCheck(t, e));
        else if (!Re[t] || ve[t]) {
          if (
            !(
              (Ot(e) &&
    ...
    return (
      (o.sanitize = function (e) {
        ...
        const c = St(qe ? e : n);
        for (; (i = c.nextNode()); ) (wt(i), vt(i), i.content instanceof s && kt(i.content));
        if (qe) return e;
        if (Be) {
